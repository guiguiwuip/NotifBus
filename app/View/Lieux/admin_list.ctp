<div class="lieux index">
	...
	<table class="table table-bordered table-hover" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><?php echo h($l['Lieux']['user_id']); ?>&nbsp;</td>
			
			<td><?php echo h($l['Lieux']['created']); ?>&nbsp;</td>
			<td><?php echo h($l['Lieux']['modified']); ?>&nbsp;</td>
			
			<td class="actions">
				<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $l['Lieux']['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $l['Lieux']['id']), null, __('Are you sure you want to delete # %s?', $l['Lieux']['id'])); ?>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
